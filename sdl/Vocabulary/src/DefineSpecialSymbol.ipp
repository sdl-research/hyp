...
#define SDL_INSTANTIATE_SPECIAL_SYMBOLS_TMP \
  SDL_PP_EXPAND(SDL_INSTANTIATE_SPECIAL_SYMBOLS) (void) sdl::BOOST_PP_CAT(Symbol_, SDL_SPECIAL_SYMBOL_NAME)::ID_LINKED; (void) sdl::BOOST_PP_CAT(Symbol_, SDL_SPECIAL_SYMBOL_NAME::TOKEN;
