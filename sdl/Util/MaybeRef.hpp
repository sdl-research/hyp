...
/** \file
 ...
 TODO: stop using since most of our types are moveable
...
struct MaybeRef {
  ...
  */
  MaybeRef(MaybeRef const& o) : val_(o.val_), free_(o.free_) { o.free_ = false; }
  ...
  */
  ...
  /**
     ...
     delete it
  */
  MaybeRef(value_type& val) : val_(&val), free_() {}
  ...
  */
  MaybeRef(value_type* val, bool free = true) : val_(val), free_(free) {}

  ~MaybeRef() {
    if (free_) delete val_;
  }
