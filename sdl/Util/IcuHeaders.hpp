...
As a workaround for Thai word breaking not working in BreakIterator UTF8, you can convert the string to UTF-16 and convert indexes to UTF-8 string indexes via u_strToUTF8(dest=NULL, destCapacity=0, *destLength gets UTF-8 index).
...
#warning "-DU_CHARSET_IS_UTF8=1 must not change - include Util/IcuHeaders.hpp first or set 'cc -DU_CHARSET_IS_UTF8=1' for all compilations using this header"
#endif
